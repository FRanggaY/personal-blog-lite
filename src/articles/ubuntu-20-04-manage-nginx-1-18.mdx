...
layout: 'article'
slug: 'ubuntu-20-04-manage-nginx-1-18'
topic: 'Setup Installation'
description: 'Manage Nginx in Ubuntu from Stratch.'
categories: ["Tutorial"]
...
<strong className="text-brand-blue-medium">Hope this article</strong> help to <strong className="text-brand-purple">install and manage Nginx in Ubuntu</strong>.
